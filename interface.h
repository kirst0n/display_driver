...
#define CUR_LOOP_ON 			1
#define CUR_LOOP_OFF 			0
#define CUR_LOOP_ERROR 			2
...
#define SAVE_COMMAND_OTSECHKA_0PER          38     //изменение самого параметра
...
#define SAVE_COMMAND_SET_OTCECHKA_0PER      66    //изменение режима
